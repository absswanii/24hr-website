...
import { CheckCircle, Truck, Users, Zap, Calendar, Target, Network } from "lucide-react"
...
export default function ServiceProviderLanding() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // TODO: Add your navigation link here
    // For now, just simulate submission
    setTimeout(() => {
      setIsSubmitting(false)
      // Navigate to your specified link
  ...
  const benefits = [
    {
      ...
      description: "Join our network and get connected to more work opportunities than ever before",
    },
    {
      icon: <Network className="h-6 w-6" />,
      title: "Exclusive Fleet Network",
      description: "Access our premium network of fleets and insurance companies actively seeking services",
    },
    {
      icon: <Zap className="h-6 w-6" />,
      title: "AI-Powered Booking",
      description: "Use our AI assistant to book appointments faster and more efficiently",
    },
    {
      icon: <Calendar className="h-6 w-6" />,
      title: "Smart Job Management",
      description: "AI helps you solidify jobs and optimize your schedule for maximum earnings",
    },
    {
      icon: <Users className="h-6 w-6" />,
      title: "Trusted Platform",
      description: "Join thousands of service providers already growing their business with us",
    },
    {
      icon: <Truck className="h-6 w-6" />,
      title: "24/7 Support",
      description: "Get round-the-clock support to help you succeed and grow your business",
    },
  ]
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="relative container mx-auto px-4 py-20">
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                Connect with our exclusive network of fleets and insurance companies. Plus, get access to AI tools that
                help you book more appointments, solidify jobs, and grow your business faster than ever.
              </motion.p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 rounded-lg border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-foreground placeholder-muted-foreground focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all duration-200"
                          required
                        />
                      </div>
                      <Button
                      ...
                      >
                        {isSubmitting ? "Getting Started..." : "Join Now & Get More Jobs"}
                      </Button>
                    </form>
                  </CardContent>
                </Card>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Join thousands of successful service providers who are already growing their business with our platform
              </p>
            </motion.div>
        ...
        <div className="py-20 bg-gradient-to-r from-primary via-secondary to-accent">
          <div className="container mx-auto px-4 text-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Ready to Get More Jobs?</h2>
              <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                Don't wait. Join our platform today and start connecting with more opportunities than ever before.
              </p>
