...
export default function FleetsPageClient() {
  return (
    <>
      ...
      {/* Our Trusted Service Providers Section */}
      <section className="py-12 w-full overflow-hidden">
        <div className="container mx-auto px-4 mb-8">
          <h2 className="text-3xl font-bold text-center mb-2">Our Trusted Service Providers</h2>
        ...
        <div className="relative w-full overflow-hidden">
          <div className="flex animate-scroll">
            ...
            <div className="flex flex-nowrap">
              <div className="flex-shrink-0 mx-8 my-4 flex items-center justify-center">
                <Image
                  src="/logos/legacy-automotive.webp"
                  alt="Legacy Automotive"
                  width={180}
                  height={90}
              ...
              <div className="flex-shrink-0 mx-8 my-4 flex items-center justify-center">
                <Image
                  ...
                  alt="Preferred Emergency Towing & Recovery"
                  width={220}
                  height={90}
                  className="h-20 w-auto object-contain"
                />
        ...
        <div className="container mx-auto px-4 mt-8 text-center">
          ...
          <Link href="/contact">
            <Button className="bg-primary hover:bg-primary/90">Become a Service Provider</Button>
          </Link>
        </div>
